...
class AddressCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ProfileCreateNestedManyWithoutAddressesInput,
  })
  @ValidateNested()
  @Type(() => ProfileCreateNestedManyWithoutAddressesInput)
  @IsOptional()
  @Field(() => ProfileCreateNestedManyWithoutAddressesInput, {
    nullable: true,
  })
  customers?: ProfileCreateNestedManyWithoutAddressesInput;
